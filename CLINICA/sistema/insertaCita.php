...
if ($hora == "") {
  ...
  print "  <p class=\"aviso\">Por favor, indique la hora de la cita >$hora</p>\n";
  print "\n";
} else {
  $horaOk = true;
}
...
if ($nombrePacienteOk && $cedulaOk && $correoOk && $idDoctorOk  && $horaOk && $descripcionOk) {
    ...
    echo json_encode(InsertarCita($nombrePaciente, $cedula, $correo,(int) $idDoctor,(int)$idSala, $fecha,(int) $hora, $descripcion));
