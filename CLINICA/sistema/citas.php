...
<div  class="navbar navbar-inverse ">
    ...
    <div id="formCitas"  class="main">
        <h3>Datos de las citas ingresadas al sistema</h3>
        <br>
      <!--  Filtrar por nombre:
        ...
        <div class="row">
            <div class="col-xs-3">
                <input class="form-control" name="filtro" type="text" id="filtroNombre"  /><br><br>
            </div>
            <div class="col-xs-3">
         <input class="form-control" type="submit" name="btResultado" value="Enviar" id="btResultado"  /><br><br>
            </div>
        --> 
        </div>
        <br>
